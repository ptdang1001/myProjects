...
def getSamplesRowColStd(part):
    ...
    if nrow > ncol:
        ...
        n = nrow
    n = n - 1
    randomRowColIdx = getRandomRowColIdx(low=0, high=n, row=2, col=7, number=sampleNum)
    samples = list()
    samplesArr = list()
    #rowStds = list()
    #colStds = list()
...
def getNewPart(samples, mateData, xn):
    ...
    #newPart = mateData.iloc[maxRowCountIdx, maxColCountIdx]
